# Generated by Django 3.2 on 2024-01-30 20:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.SlugField(choices=[('user', 'пользователь'), ('admin', 'администратор'), ('moderator', 'модератор')], default='user', verbose_name='роль пользователя')),
